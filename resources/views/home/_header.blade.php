          ...
          <div class="container">
              <nav class="navbar navbar-dark bg-dark">
                  <a class="logo" href="index.html"><img
                          src="{{ asset('assets') }}/site/images/logo.png"></a>
                  <div class="search_section">
                      <ul>
                          @auth
                              <li><strong>{{ Auth::user()->name }}</strong></li>
                              @elseauth
                              <li><a href="{{ route('admin_login') }}">Log In</a></li>
                          @endauth
                          <li><a href="#"><img src="{{ asset('assets') }}/site/images/shopping-bag.png"></a></li>
                      </ul>
                  </div>
                  ...
                  <div class="collapse navbar-collapse" id="navbarsExample01">
                      <ul class="navbar-nav mr-auto">
                          <li class="nav-item active">
                              <a class="nav-link" href="{{route('site_index')}}">Home</a>
                          </li>
                          <li class="nav-item">
                      ...
                      <div class="carousel-item active">
                          <div class="container">
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div><img src="{{ asset('assets') }}/site/images/img-1.png"
                                              class="image_1"></div>
                                  </div>
                              </div>
