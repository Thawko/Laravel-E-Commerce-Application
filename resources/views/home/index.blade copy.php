            ...
            <div class="row">
               <div class="col-lg-4 col-sm-12">
                  <div class="beauty_box">
                     ...
                     <div><img src="{{ asset('assets') }}/site/images/img-5.png" class="image_3"></div>
               ...
               <div class="col-lg-8 col-sm-12">
                  <div class="beauty_box_1">
                     ...
                     <div><img src="{{ asset('assets') }}/site/images/img-6.png" class="image_3"></div>
               ...
               <div class="row">
                  <div class="col-sm-5">
                     <div class="feature_box">
                        ...
                        <div><img src="{{ asset('assets') }}/site/images/img-7.png" class="image_7"></div>
                     </div>
                  ...
                  <div class="col-sm-7">
                     <div class="feature_box_2">
                        <h1 class="readable_text">Readable content of</h1>
                        <div><img src="{{ asset('assets') }}/site/images/img-8.png" class="image_8"></div>
                        <div class="seemore_bt"><a href="#">see More</a></div>
                     </div>
                  </div>
               </div>
      ...
      <div class="client_section layout_padding">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-item active">
                  <div class="container">
                     ...
                     <div class="client_section_2">
                        <div class="image_9"><img src="{{ asset('assets') }}/site/images/img-9.png"></div>
                        ...
                        <div class="image_9"><img src="{{ asset('assets') }}/site/images/icon-10.png"></div>
                     </div>
                  </div>
               </div>
            ...
            <i class=""><img src="{{ asset('assets') }}/site/images/left-icon.png"></i>
            </a>
            <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
            <i class=""><img src="{{ asset('assets') }}/site/images/right-icon.png"></i>
            </a>
         </div>
      </div>
      <!-- client section end -->
